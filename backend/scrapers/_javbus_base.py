...
async def fetch_detail(url: str, base_url: str, source: str,
    ...
    try:
        async with httpx.AsyncClient(
            ...
            # JavBus renders samples in the detail HTML, while magnets are an
            # HTML fragment loaded from its own AJAX endpoint.  The required
            # request values are emitted as simple page variables.
            ...
            if gid and uc and img:
                ...
                try:
                    ...
                    # Samples are still a successful result when the optional
                    # magnet fragment is temporarily unavailable.
